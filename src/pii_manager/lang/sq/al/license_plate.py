...
class AlbanianLicensePlate(BasePiiTask):
    """
    Albanian license plate numbers recognize
    """
    ...
    def find(self, doc: str) -> Iterable[PiiEntity]:
        ...
        for item in self.license_plate_pattern.finditer(doc):
            ...
            yield PiiEntity(
                ...
                name="Albanian license plate",
            )
# Task descriptor
PII_TASKS = [(PiiEnum.LICENSE_PLATE, AlbanianLicensePlate)]