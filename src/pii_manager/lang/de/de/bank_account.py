"""
German frequent bank account numbers
"""
...
class GermanBankAccount(BasePiiTask):
    """
    German frequent bank account numbers recognize
    """

    pii_name = "German Bank Account"
...
# Task descriptor
PII_TASKS = [(PiiEnum.BANK_ACCOUNT, GermanBankAccount)]