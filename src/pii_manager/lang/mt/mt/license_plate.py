...
_LICENSE_PLATE_PATTERN = r"\b[A-Z]{3}\s?\d{3,4}\b"



class MalteseLicensePlate(BasePiiTask):
    """
    Maltese license plate numbers recognize
    """
...
# Task descriptor
PII_TASKS = [(PiiEnum.LICENSE_PLATE, MalteseLicensePlate)]