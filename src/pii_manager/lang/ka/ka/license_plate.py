...
class GeorgianLicensePlate(BasePiiTask):
    """
    Georgian license plate numbers recognize
    """
    ...
    def find(self, doc: str) -> Iterable[PiiEntity]:
        ...
        for item in self.license_plate_pattern.finditer(doc):
            ...
            yield PiiEntity(
                ...
                name="Georgian license plate",
            )
# Task descriptor
PII_TASKS = [(PiiEnum.LICENSE_PLATE, GeorgianLicensePlate)]