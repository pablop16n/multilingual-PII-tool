"""
Czech frequent bank account numbers
"""
...
class CzechBankAccount(BasePiiTask):
    """
    Czech frequent bank account numbers recognize
    """

    pii_name = "Czech Bank Account"
    ...
    def find(self, doc: str) -> Iterable[PiiEntity]:
        ...
        for item in self.ba_pattern.finditer(doc):
            ...
            yield PiiEntity(
                ...
                name="Czech Bank Account",
            )

# Task descriptor
PII_TASKS = [(PiiEnum.BANK_ACCOUNT, CzechBankAccount)]