...
_LICENSE_PLATE_PATTERN = r"\b[A-HJ-PR-UW-Z]{3}[ -]?\d{3}\b"



class SwedishLicensePlate(BasePiiTask):
    """
    Swedish license plate numbers recognize
    """
    ...
    def find(self, doc: str) -> Iterable[PiiEntity]:
        ...
        for item in self.license_plate_pattern.finditer(doc):
            ...
            yield PiiEntity(
                ...
                name="Swedish license plate",
            )
# Task descriptor
PII_TASKS = [(PiiEnum.LICENSE_PLATE, SwedishLicensePlate)]