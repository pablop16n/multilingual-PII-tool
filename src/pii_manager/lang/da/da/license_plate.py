...
_LICENSE_PLATE_PATTERN = r"\b[A-Z]{2}\s?\d{2}\s?\d{3}\b"



class DanishLicensePlate(BasePiiTask):
    """
    Danish license plate numbers recognize
    """
    ...
    def find(self, doc: str) -> Iterable[PiiEntity]:
        ...
        for item in self.license_plate_pattern.finditer(doc):
            ...
            yield PiiEntity(
                ...
                name=" Danish license plate",
            )
# Task descriptor
PII_TASKS = [(PiiEnum.LICENSE_PLATE, DanishLicensePlate)]