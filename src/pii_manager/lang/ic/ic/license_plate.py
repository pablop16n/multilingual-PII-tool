...
_LICENSE_PLATE_PATTERN = r"\b[A-Z]{2}[ -]?([A-Z]\d{2}|\d{3})\b"



class IcelandicLicensePlate(BasePiiTask):
    """
    Icelandic license plate numbers recognize
    """
...
# Task descriptor
PII_TASKS = [(PiiEnum.LICENSE_PLATE, IcelandicLicensePlate)]